...
- 208fe98: Drop `zod` as a dependency to keep the package lean. Config parsing does the same job by hand, with three behaviour fixes:
...
- 018a3ec: update dependencies
- 445e254: switch to changesets (will change changelogs)
